...
const envOptions = {
  ...
  expLoader: Boolean(process.env.EXPERIMENTAL_TESTS),
};
...
async function getProjectConfig(targetPath, displayName) {
  ...
  const options = {
    ...
    coverageProvider: envOptions.expLoader ? undefined : 'v8',
    ...
    transform: {
      '\\.(js|jsx|ts|tsx|mjs|cjs)$': [
        ...
        {
          enableSourceMaps: envOptions.enableSourceMaps || envOptions.expLoader,
        },
      ],
    ...
    moduleLoader: envOptions.expLoader
